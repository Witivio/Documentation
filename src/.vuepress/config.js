      ...
      "/solutions/": [
        {
          ...
          children: [
            ["/solutions/", "Overview"],
            {
              ...
              children: [
                ["/solutions/aidesk-pro/overview.md", "Overview"],
                ["/solutions/aidesk-pro/get-started.md", "Get Started !"],
                {
                  title: "Fundamentals",
                  collapsable: true,
                  children: [
                    ["/solutions/aidesk-pro/fundamentals/authentication.md", "Authentication & Authorization"],
                    ["/solutions/aidesk-pro/fundamentals/dashboard.md", "Dashboard"],
                    {
                      title: "Documents",
                      collapsable: true,
                      children: [
                        ["/solutions/aidesk-pro/fundamentals/documents.md", "Overview"],
                        ["/solutions/aidesk-pro/fundamentals/local-documents.md", "Local Documents"],
                        ["/solutions/aidesk-pro/fundamentals/sharepoint-libraries.md", "SharePoint Libraries"],
                        ["/solutions/aidesk-pro/fundamentals/sharepoint-pages.md", "SharePoint Pages"],
                      ],
                    },
                    ["/solutions/aidesk-pro/fundamentals/history.md", "History"],
                    ["/solutions/aidesk-pro/fundamentals/prompts.md", "Prompts"],
                    ["/solutions/aidesk-pro/fundamentals/system-prompt.md", "Instructions"],
                    ["/solutions/aidesk-pro/fundamentals/welcome-card.md", "Welcome Card"],
                    ["/solutions/aidesk-pro/fundamentals/Action-bar.md", "Action bar"],
                    ["/solutions/aidesk-pro/fundamentals/manage-plugins.md", "Plugins"],
                    ["/solutions/aidesk-pro/fundamentals/Agent-Maker.md", "Agent Maker"],
                    ["/solutions/aidesk-pro/fundamentals/Knowledge-Base-Editor.md", "Knowledge Base"],
                    ["/solutions/aidesk-pro/fundamentals/manage-administrators.md", "Administrator"],
                    ["/solutions/aidesk-pro/fundamentals/notebook.md", "Notebook"],
                    ["/solutions/aidesk-pro/fundamentals/push-communication.md", "Push Communication"],
                    ["/solutions/aidesk-pro/fundamentals/feedbacks.md", "Feedbacks"],
                    ["/solutions/aidesk-pro/fundamentals/webchat.md", "Webchat"],
                    ["/solutions/aidesk-pro/fundamentals/Agent-customization.md", "Agent customization"],
                    ["/solutions/aidesk-pro/fundamentals/mcp-server.md", "MCP Server (Preview)"],
                  ],
                },
                ["/solutions/aidesk-pro/whats-new.md", "What’s new​"],
                {
                  title: "Tutorials & tips",
                  collapsable: true,
                  children: [
                    ["/solutions/aidesk-pro/tutorials/plugins.md", "Plugins"],
                    ["/solutions/aidesk-pro/tutorials/high-permorming-agent.md", "High-Performing Agent"]
                ],
                },
                {
                  title: "Migrations",
                  collapsable: true,
                  children: [
                    ["/solutions/aidesk-pro/migrations/faq.md", "FAQ"],
                    ["/solutions/aidesk-pro/migrations/movestream.md", "MoveStream Program"],
                  ],
                },
                ["/solutions/gpt-pro/limits.md", "Limits"],
                ["/solutions/gpt-pro/content-filter.md", "Content filtering"],
                ["/solutions/aidesk-pro/preview-features.md", "Preview features"],
            ...
            },
            {
              ...
              children: [
                ...
                ["/solutions/gpt-pro/getting-started-with-gpt-pro/get-started-guide.md", "Get Started !"],
