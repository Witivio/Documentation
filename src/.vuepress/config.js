      ...
      "/solutions/": [
        {
          ...
          children: [
						...
						},*/
            {
              title: "AI Desk",
              collapsable: true,
              path: "/solutions/ai-desk/overview/",
              children: [
                ["/solutions/ai-desk/overview.md", "Overview"],
                ["/solutions/ai-desk/get-started.md", "Get Started !"],
                {
                  title: "Fundamentals",
                  collapsable: true,
                  children: [
                    ["/solutions/ai-desk/fundamentals/authentication.md", "Authentication & Authorization"],
                    ["/solutions/ai-desk/fundamentals/dashboard.md", "Dashboard"],
                    ["/solutions/ai-desk/fundamentals/documents.md", "Documents"],
                    ["/solutions/ai-desk/fundamentals/history.md", "History"],
                    ["/solutions/ai-desk/fundamentals/prompts.md", "Prompts"],
                    ["/solutions/ai-desk/fundamentals/system-prompt.md", "Instructions"],
                    ["/solutions/ai-desk/fundamentals/welcome-card.md", "Welcome Card"],
                    ["/solutions/ai-desk/fundamentals/Action-bar.md", "Action bar"],
                    ["/solutions/ai-desk/fundamentals/manage-plugins.md", "Plugins"],
                    ["/solutions/ai-desk/fundamentals/GPT-Maker.md", "GPT Maker"],
                    ["/solutions/ai-desk/fundamentals/Knowledge-Base-Editor.md", "Knowledge Base"],
                    ["/solutions/ai-desk/fundamentals/manage-administrators.md", "Administrator"],
                    ["/solutions/ai-desk/fundamentals/notebook.md", "Notebook"],
                    ["/solutions/ai-desk/fundamentals/push-communication.md", "Push Communication"],
                    ["/solutions/ai-desk/fundamentals/feedbacks.md", "Feedbacks"],
                    ["/solutions/ai-desk/fundamentals/webchat.md", "Webchat"],
                  ],
                },
                ["/solutions/ai-desk/whats-new.md", "What’s new​"],
                {
                  title: "Tutorials & tips",
                  collapsable: true,
                  children: [
                    ["/solutions/ai-desk/tutorials/plugins.md", "Plugins"],
                    ["/solutions/ai-desk/tutorials/high-permorming-agent.md", "High-Performing Agent"]
                ],
                },
                {
                  title: "Migrations",
                  collapsable: true,
                  children: [
                    ["/solutions/ai-desk/migrations/faq.md", "FAQ"],
                    ["/solutions/ai-desk/migrations/movestream.md", "MoveStream Program"],
                  ],
                },
                ["/solutions/ai-desk/limits.md", "Limits"],
                ["/solutions/ai-desk/content-filter.md", "Content filtering"],
                ["/solutions/ai-desk/roadmap.md", "Roadmap"],
                //["/solutions/ai-desk/changelog.md", "Change log​"],
              ],
            },
            {
        ...
        },
        {
          ...
          children: [
            ...
            ["/architecture-security/ai-desk/", "AI Desk"],
