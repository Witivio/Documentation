...
Welcome card is an intuitive, interactive prompt shortcut that greets users upon accessing AI desk PRO chatbox. It provides an array of quick-start options designed to assist users in navigating the service, whether they want to understand a concept, create content, or explore resources. It streamlines the user experience by offering suggestions that help users immediately leverage the capabilities of AI desk PRO.

## How does a welcome card work?
To manage your welcome card, simply click on `Prompt` in your admin center navigation bar, then `Welcome Card` in its sub navigation bar. Upon registering to AI desk PRO, two welcome cards will be set up automatically as a default model. Both versions are in french and english. The welcome card's language will follow the language set up on user's Microsoft Teams.

![Welcome card overview](/assets/img/agent/welcome-card-1.png)
...
![Welcome card](/assets/img/agent/welcome-card-2.png)
...
![Welcome card](/assets/img/agent/system-prompt.png)
