# Overview
This guide provides detailed instructions for managing local documents within AI desk PRO's knowledge base through the admin portal. Local documents are files that you upload directly from your device to AI desk PRO.
...
![Manage documents](/assets/img/agent/Local-documents.png)

# Uploading a Document

:::tip
💡To keep AI desk PRO's knowledge base up to date, regularly upload new documents.
:::
...
- Use the `Actions` dropdown next to each document to:
  ...
  - **Delete**: Remove the document from AI desk PRO.

# Best Practices
- Update and review documents regularly.
- Remove outdated content to maintain AI desk PRO's performance.
