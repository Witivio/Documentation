...
- Control user access to the application directly within their Microsoft Entra ID environment, simplifying management for security teams.
...
- From __Enterprise applications__ panel in Microsoft Entra ID **after connecting successfully to AI desk PRO Admin center.**
