...
The Knowledge Base (KB) Editor in AI desk PRO is a powerful tool designed to help users create, manage, and update internal knowledge bases effortlessly. This tool centralizes critical information, ensuring that the virtual agent provides accurate, consistent, and up-to-date responses.

## Accessing the Q&A Editor

To access the KB Editor, navigate to the AI desk PRO admin panel at `admin.aidesk-pro.com` and select the Knowledge option from the side menu and choose Questions/answers. Three tabs are available: 'Q&A configuration', 'Images gallery', and 'Tags'.

![Q&A editor](/assets/img/agent/QnA-editor.png)
...
![QnA creation](/assets/img/agent/QnA-creation.png)
...
![Knowledge base editor](/assets/img/agent/answer-type.png)
...
![simple answer creation](/assets/img/agent/simple-answer-creation.png)
   ...
   ![Simple answer draft](/assets/img/agent/simple-answer-draft.png)
...
Card anwser allows to add title, images, buttons.
  ...
  ![Card answer creation](/assets/img/agent/card-answer-creation.png)
  ...
  ![Card answer published](/assets/img/agent/card-answer-published.png)
...
##### Dialog:
Dialog anwser in AI desk PRO enable the creation of dynamic, multi-step conversations through a no-code visual editor. These flows help guide users through complex scenarios using conditional logic, variables, API calls, and user input collection.

#### Accessing the Dialogue Editor
1. Navigate to the **Agent Maker** section of your admin panel.
...
4. Click on the created question to open the visual Dialog Editor.
 ...
 ![Card answer published](/assets/img/agent/dialog.png)
...
2. **Save**: Click on `Save` to apply the changes.
 ...
 ![Add image](/assets/img/agent/add-image.png)
...
2. **Add a new folder**: Click on '+Add a folder' to create a new folder.
 ...
 ![Add image](/assets/img/agent/add-folder.png)
...
The image list shows the number of times each tag is used in questions.
 ...
 ![Tags](/assets/img/agent/images-list.png)
...
![Tags](/assets/img/agent/add-tag.png)
...
The tag list shows the number of times each tag is used in questions.
 ...
 ![Tags](/assets/img/agent/Tags.png)
