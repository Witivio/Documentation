...
Company Communicator is a feature integrated into AI desk PRO that enables proactive and targeted notifications via Microsoft Teams, enhancing internal communication and responsiveness within your organization.
...
1. Access Agents, then select the "Communication Tab."
2. Log in using your Windows credentials.
3. The application opens on the "Message Management" interface.

### Initial Configuration
![Company Communicator Pro Dashboard](/assets/img/agent/ccp-dashboard.png)
...
## Message Management
![Company Communicator Pro Message](/assets/img/agent/ccp-message.png)
...
![Company Communicator Pro Message](/assets/img/agent/ccp-teams.png)

## Detailed Statistics and Analytics

### Campaign Reports
![Company Communicator Pro Message](/assets/img/agent/ccp-statistics.png)
- **Filters:** filter campaigns by Agent or author.
