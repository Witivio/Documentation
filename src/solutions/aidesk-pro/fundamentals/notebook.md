...
The Notebook is a feature available within Teams, integrated into each Agent created with AI desk PRO, that allows the creation of an initial prompt and the ability to modify it directly in a text box. This enables users to adjust their request without starting a new conversation. With just one click, queries can be refined, and personalized responses are provided instantly.
...
To access the Notebook feature, open your Agent in Teams. The Notebook will be available as a tab into the Agent.

![Notebook](/assets/img/agent/notebook.png)
...
![Notebook](/assets/img/agent/notebook-actions.png)