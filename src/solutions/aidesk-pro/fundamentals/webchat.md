...
![Webchat configuration](/assets/img/agent/webchat-configuration.png)
...
![Action on library](/assets/img/agent/webchat-authent.png)
...
And use this **"AI desk PRO Witivio"** component, follow these steps:
...
![Properties](/assets/img/agent/sharepoint-properties.png)
3. A pop-up window will appear.  
![Configuration](/assets/img/agent/sharepoint-configuration.png)
4. Enter the **Agent ID**, which you can find in the URL of AI desk PRO Admin center.  
![GPTPRO ID](/assets/img/agent/agent-id.png)
...
⚠️ **Don’t forget to add your site’s URL in the "Security" tab of AI desk PRO to ensure proper functionality.**
...
Once authenticated, AI desk PRO applies their SharePoint and Microsoft 365 permissions automatically.
:::
...
![Webchat](/assets/img/agent/webchat-gptpro.png)
...
- **Before installation**, ensure your site’s URL is added in the **Security** tab in AI desk PRO Admin center.  
...
All Webchat traffic goes through a **Bot Framework token**. This token can only be generated from **authorized pages** defined in AI desk PRO configuration (see [2.3 Configuring Security](#23-configuring-security)). Make sure to add every domain where the Webchat is embedded.

### 5.4 Flow diagram (message sending)

![Webchat diagram](/assets/img/agent/webchat-diagram-drawing.png)
