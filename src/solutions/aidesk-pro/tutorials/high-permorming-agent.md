# Optimized Instructions Writing for AI desk PRO  
...
AI desk PRO follows instructions based on logical structure. A clear format helps prevent ambiguity and ensures consistent, reliable behavior.
...
---
# AI desk PRO Agent Optimization & Configuration
...
Documents are split into small text chunks and vectorized. When a question is asked, Agent performs a similarity search.
### Best practices  
