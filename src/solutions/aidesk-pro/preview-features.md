...
- Evaluate new behaviors or configurations  
- Provide structured feedback  
- Anticipate future platform evolution  
 
Preview features:
 
- Are governed by specific **Supplemental Preview Terms of Use**  
- Are intended for controlled evaluation  
- May evolve during the Preview phase  
- May have limited scope or availability  
- May be updated, refined, or withdrawn at any time  
...
- Ensure activation is limited to appropriate agents  
- Avoid relying on Preview features for critical business processes  
- Inform relevant internal stakeholders  
- Review the applicable Preview Terms  
...
To enable Preview mode, you must:
 
- Have administrator permissions for the relevant agent  
- Have access to the agent configuration settings  
...
- The selected Preview capabilities become active on the agent  
- The agent’s behavior or internal logic may evolve during the Preview phase  
- Changes may occur without additional notice  
...
- Describe the usage context  
- Compare expected versus observed behavior  
- Analyze before/after differences  
- Qualify the perceived impact on user experience  
 
### Important
 
- Feedback submitted through this form is reviewed globally  
- It does not trigger individual follow-up or personalized responses  
- The Preview form is not a support channel  
- No support tickets should be opened for Preview features  
...
- Are made available on an early-access basis  
- May evolve, be modified, or be discontinued at any time  
- May have limited functional or behavioral scope  
...
UNLESS OTHERWISE EXPRESSLY STATED IN THE MASTER AGREEMENT, PREVIEW FEATURES ARE PROVIDED **“AS IS”** AND **“AS AVAILABLE.”**
 
PREVIEW FEATURES ARE NOT COVERED BY SERVICE LEVEL AGREEMENTS (SLA).
...
Preview Features must not be used for critical business processes.
 
Activation must occur within controlled environments.
...
Preview Features may be subject to different or reduced commitments regarding:
...
Certain Preview Features may incorporate generative AI capabilities.
 
Behavior and outputs may evolve.
...
Experimental or early-access Preview Features are intended solely for internal evaluation.
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, AI DESK PRO SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM THE USE OF PREVIEW FEATURES.
...
AI DESK PRO RETAINS SOLE DISCRETION TO GENERALIZE, MODIFY, MAINTAIN IN PREVIEW, OR DISCONTINUE ANY PREVIEW FEATURE.
...
Certain Preview Features may, following the evaluation phase, be:
 
- Included in a paid plan  
- Offered as a paid add-on or module  
- Integrated into a different subscription tier  
 
Access to a Preview Feature during the evaluation phase does not guarantee future free access.
 
Any pricing evolution will be communicated prior to activation or billing.