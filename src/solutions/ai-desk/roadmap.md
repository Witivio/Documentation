                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.7s">
                                    ...
                                    <div class="timeline-text">
                                        ...
                                        <p>Simple answers; using the knowledge base as a GenIA data source; save answers written as AI Desk answers.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.3s">
                                    ...
                                    <div class="timeline-text">
                                        ...
                                        <p>Guide to support the administrator in adopting AI Desk. License assignment rates, usage rates</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4">
