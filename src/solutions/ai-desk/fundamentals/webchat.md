...
And use this **"AI Desk Witivio"** component, follow these steps:
...
4. In the search bar, type **"AI Desk Witivio"**.  
5. Select **"AI Desk Witivio"** and add it at the top of the page.  
---
...
4. Enter the **GPT ID**, which you can find in the URL of AI Desk Admin center.  
![GPTPRO ID](/assets/img/gpt/gpt-id.png)
5. Enter the **API Key** from AI Desk:  
...
⚠️ **Don’t forget to add your site’s URL in the "Security" tab of AI Desk to ensure proper functionality.**
...
- **Before installation**, ensure your site’s URL is added in the **Security** tab in AI Desk Admin center.  
